...
const CustomToast = React.forwardRef<React.ElementRef<typeof Toast.Root>, CustomToastProps>(
...
CustomToast.displayName = Toast.Root.displayName
...
export { CustomToast as Toast, ToastProvider, ToastViewport, ToastAction, ToastClose, ToastTitle, ToastDescription }
